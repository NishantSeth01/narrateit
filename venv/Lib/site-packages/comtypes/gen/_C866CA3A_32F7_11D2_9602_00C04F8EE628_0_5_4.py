...
__all__ = [
    ...
    'DISPID_SRGIsPronounceable', 'DISPID_SPRulesItem',
    'DISPID_SPRuleName', 'DISPID_SPRs_NewEnum', 'SVSFPersistXML',
    'SGRSTTEpsilon', 'DISPID_SWFEExtraData',
    'DISPID_SpeechPhraseReplacements', 'SVEEndInputStream',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPAsCount',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SABIMinNotification', 'SPEI_RESERVED1', 'DISPID_SVVoice',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPPS_Noun',
    'DISPID_SMSGetData', 'SPAUDIOOPTIONS', 'SPVPRI_OVER',
    'SDTReplacement', 'SPCT_SUB_COMMAND', 'DISPID_SDKGetStringValue',
    'SpeechEngineConfidence', 'SpeechVisemeFeature', 'SVP_15',
    'DISPID_SVAudioOutput', 'DISPID_SOTCSetId', 'DISPID_SPEs_NewEnum',
    'SPEI_PHONEME', 'SPFM_NUM_MODES', 'DISPID_SpeechAudio',
    'SPAR_Medium', 'SPEI_PHRASE_START',
    ...
    'SPRST_INACTIVE', 'SAFT8kHz16BitStereo',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SDKOpenKey',
    'DISPID_SGRSTText', 'eLEXTYPE_RESERVED4',
    ...
    'SGRSTTDictation', 'SPPS_Noncontent', 'eLEXTYPE_PRIVATE1',
    'SSTTDictation', 'eLEXTYPE_RESERVED9', 'SPXRO_Alternates_SML',
    'SPAR_Unknown', 'eLEXTYPE_PRIVATE19', 'SPSHT_NotOverriden',
    'ISpeechPhraseInfoBuilder', 'ISpStreamFormat',
    'DISPID_SAFSetWaveFormatEx', 'SVEVoiceChange',
    'DISPID_SGRSTNextState', 'SDA_Two_Trailing_Spaces',
    'SP_VISEME_19', 'SPRS_ACTIVE_USER_DELIMITED',
    'SDKLDefaultLocation', 'SpeechLexiconType',
    'SAFTADPCM_22kHzStereo', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SP_VISEME_18', 'ISpeechPhraseProperties', 'DISPID_SABufferInfo',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SVEventInterests',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SLGetGenerationChange',
    'SPWORDPRONUNCIATION', 'DISPID_SRIsUISupported',
    'SpResourceManager', 'SpeechWordType',
    'SpeechEmulationCompareFlags', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPAsItem', 'SPAS_PAUSE', 'Speech_Default_Weight',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SpeechLexiconWord',
    'DISPID_SRRGetXMLErrorInfo', '__MIDL_IWinTypes_0009',
    'DISPID_SDKEnumKeys', 'DISPID_SpeechGrammarRule',
    'SDKLCurrentConfig', 'DISPID_SWFEBlockAlign', 'SPAS_STOP',
    'DISPID_SFSOpen', 'SPWORDPRONUNCIATIONLIST', 'DISPID_SRStatus',
    'SPPS_Function', 'SpeechVoicePriority',
    'SpeechPropertyHighConfidenceThreshold', 'ISpObjectTokenCategory',
    'DISPID_SRCRetainedAudioFormat', 'SGDSActiveUserDelimited',
    'SPPS_RESERVED1', 'SSFMCreateForWrite', 'SP_VISEME_9',
    'SDTProperty', 'DISPID_SVSLastStreamNumberQueued',
    'SPEI_TTS_PRIVATE', 'SPCS_DISABLED', 'SVPNormal',
    'SpeechRegistryUserRoot', 'SpeechCategoryVoices',
    'ISpeechWaveFormatEx', 'DISPID_SVAlertBoundary',
    'DISPID_SASNonBlockingIO', 'SPEI_START_INPUT_STREAM',
    'DISPID_SLWLangId', 'SVPOver', 'SpeechAllElements',
    'SAFT8kHz16BitMono', 'ISpeechPhraseRules', 'SPSTREAMFORMATTYPE',
    'DISPID_SAFGetWaveFormatEx', 'SAFT44kHz16BitMono', 'SpShortcut',
    'DISPID_SDKGetBinaryValue', 'DISPID_SRGSetTextSelection',
    'DISPID_SRCEAdaptation', 'DISPID_SPIGetDisplayAttributes',
    'SPEVENT', 'SpeechDisplayAttributes',
    ...
    'IEnumSpObjectTokens', 'SPCT_SLEEP', 'SP_VISEME_20',
    'SpMMAudioIn', 'SVSFNLPMask', 'STCInprocServer', 'SPEI_UNDEFINED',
    'DISPID_SPRNumberOfElements', 'SP_VISEME_12',
    'SAFT48kHz16BitMono', 'DISPID_SVPriority',
    'SpeechGrammarWordType', 'SPSVerb', 'SPGS_ENABLED', 'SRTStandard',
    'SpeechTokenContext', 'SECHighConfidence', 'SpLexicon',
    'SREBookmark', 'DISPID_SPRText', 'SREStreamEnd',
    'DISPID_SPAs_NewEnum', 'SAFT8kHz8BitStereo',
    'SSSPTRelativeToCurrentPosition', 'SINone', 'SECFDefault',
    ...
    'ISpRecoContext2', 'SP_VISEME_11', 'SGDSInactive', 'SPCS_ENABLED',
    'SP_VISEME_0', 'DISPID_SVIsUISupported', 'SPSFunction',
    ...
    'SECFIgnoreCase', 'DISPID_SRCPause', 'eLEXTYPE_PRIVATE9',
    'DISPID_SGRSTRule', 'eLEXTYPE_PRIVATE17', 'SpeechUserTraining',
    'SpeechLoadOption', 'STCInprocHandler', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRIsShared', 'SVF_None', 'SpeechPropertyResponseSpeed',
    'SDKLLocalMachine', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SpeechGrammarRules', 'DISPID_SVPause', 'ISpeechDataKey',
    'DISPID_SpeechVoiceStatus', 'DISPID_SVEEnginePrivate',
    'SPSHT_EMAIL', 'SpeechTokenValueCLSID', 'SpeechAddRemoveWord',
    'DISPID_SASetState', 'SpeechPropertyResourceUsage',
    'DISPID_SWFEFormatTag', 'DISPID_SVVolume', 'SVEWordBoundary',
    'DISPID_SGRsItem', 'DISPID_SVSRunningState', 'ISpEventSource',
    'SpeechRuleAttributes', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRRTTickCount', 'DISPID_SGRs_NewEnum', 'SPPS_RESERVED3',
    'SPSERIALIZEDRESULT', 'SPRS_ACTIVE', 'DISPID_SOTs_NewEnum',
    'DISPID_SpeechLexicon', 'SAFTGSM610_44kHzMono', 'SPBO_AHEAD',
    'SPSHORTCUTPAIR', 'SPSModifier', 'DISPID_SPEsItem',
    'DISPID_SPIGrammarId', 'STSF_CommonAppData', 'ISpVoice',
    'DISPIDSPTSI_SelectionLength', 'ISpeechGrammarRule',
    'DISPID_SVEBookmark', 'DISPID_SpeechAudioFormat',
    'SPRECORESULTTIMES', 'DISPID_SGRClear', 'STSF_AppData',
    'SPGRAMMARWORDTYPE', 'STCLocalServer', 'DISPID_SPPsCount',
    'SPFM_CREATE_ALWAYS', 'SRADynamic',
    'SpeechGrammarTagUnlimitedDictation', 'SITooQuiet',
    'SPCT_SUB_DICTATION', 'ISpNotifySink', 'Speech_Max_Pron_Length',
    'SPPS_SuppressWord', 'DISPID_SPRFirstElement',
    'SPAUDIOBUFFERINFO', 'DISPID_SVEViseme',
    'ISpeechGrammarRuleState', 'DISPID_SRGetPropertyNumber',
    'SPEI_TTS_BOOKMARK', 'DISPID_SpeechWaveFormatEx',
    'SVSFParseAutodetect', 'DISPID_SREmulateRecognition',
    'DISPID_SPPsItem', 'DISPID_SLWs_NewEnum',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SGRSAddSpecialTransition',
    'SVSFUnusedFlags', 'STCAll', 'DISPID_SPPId',
    'SAFTCCITT_uLaw_44kHzMono', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SRCEHypothesis', 'SP_VISEME_8', 'SPLO_STATIC',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRGetPropertyString',
    'SREAllEvents', 'SpeechGrammarTagWildcard',
    'SpeechCategoryPhoneConverters', 'SVP_6', 'DISPID_SLPLangId',
    'DISPID_SPEAudioSizeTime', 'SPFM_OPEN_READONLY',
    'ISpPhoneticAlphabetSelection', 'tagSTATSTG', 'SVSFParseMask',
    'SP_VISEME_6', 'SVF_Emphasis', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SDKCreateKey', 'eLEXTYPE_PRIVATE4',
    'SpeechRetainedAudioOptions', 'DISPID_SASFreeBufferSpace',
    'SDTAudio', 'SpeechVoiceEvents', 'SAFTCCITT_ALaw_44kHzMono',
    'SPSEMANTICFORMAT', 'SPSHT_OTHER', 'DISPID_SOTSetId',
    'DISPID_SRSetPropertyNumber', 'SRERecoOtherContext',
    'DISPID_SpeechVoiceEvent', 'SPVOICESTATUS',
    'DISPID_SRSSupportedLanguages',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFTDefault',
    'ISpeechMMSysAudio', 'SP_VISEME_21', 'SVP_4',
    'DISPID_SRGetFormat', 'SpeechPropertyAdaptationOn',
    'DISPID_SRCRequestedUIType', 'DISPID_SPILanguageId',
    'DISPID_SMSSetData', 'SVF_Stressed', 'ISpeechPhraseReplacement',
    'SPEI_RESERVED6', 'SpeechSpecialTransitionType',
    'DISPID_SPIEngineId', 'DISPID_SGRAddState',
    'SpeechBookmarkOptions', '_ISpeechRecoContextEvents',
    'SGSExclusive', 'SECLowConfidence', 'DISPID_SRGDictationSetState',
    'SPTEXTSELECTIONINFO', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SLWsItem', 'DISPID_SRCRecognizer',
    'DISPID_SpeechRecoResultTimes', 'tagSPTEXTSELECTIONINFO',
    'SpStreamFormatConverter', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SPERetainedSizeBytes', 'SAFTExtendedAudioFormat',
    'DISPID_SGRInitialState', 'SAFT32kHz8BitStereo',
    'SPEI_RECO_OTHER_CONTEXT', 'SVP_8', '_ISpeechVoiceEvents',
    'ISpPhrase', 'DISPID_SpeechPhraseAlternate', 'SRAExport',
    'ISpRecoContext', 'SVSFPurgeBeforeSpeak', 'DISPID_SGRSTsItem',
    'DISPID_SRCSetAdaptationData', 'ISpObjectToken',
    'DISPID_SpeechMMSysAudio', 'SVSFDefault',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpeechGrammarState',
    'DISPID_SVSInputSentencePosition', 'SRESoundStart',
    'DISPID_SOTRemove', 'DISPID_SGRsDynamic', 'SPEI_REQUEST_UI',
    'DISPID_SPIProperties', 'SPINTERFERENCE_NOSIGNAL',
    'IInternetSecurityManager', '_RemotableHandle',
    'DISPID_SVSpeakStream', 'eLEXTYPE_PRIVATE2',
    'DISPID_SLGenerationId', 'SVP_19', 'SGRSTTWord', 'SP_VISEME_14',
    'SPSLMA', 'DISPID_SPEDisplayAttributes',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SVEAudioLevel',
    'SINoSignal', 'DISPID_SRRTOffsetFromStart', 'SVSFIsNotXML',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SDKEnumValues',
    'DISPID_SRGState', 'ISpeechRecoContext', 'DISPID_SGRName',
    'DISPID_SOTCId', 'SPEI_TTS_AUDIO_LEVEL', 'ISpeechPhraseElement',
    'ISpMMSysAudio', 'SAFT24kHz8BitMono', 'DISPID_SVGetAudioInputs',
    'DISPID_SGRSAddWordTransition', 'DISPID_SVSCurrentStreamNumber',
    'eLEXTYPE_PRIVATE20', 'SpeechAudioState', 'SPEI_SR_RETAINEDAUDIO',
    'SpeechRecoContextState', 'DISPID_SRRecognizer',
    'DISPID_SPERetainedStreamOffset', 'SPBO_TIME_UNITS',
    'SRESoundEnd', 'ISpeechAudioStatus',
    'SpeechStreamSeekPositionType', 'SpStream', 'SVP_10',
    'DISPID_SpeechPhraseProperty', 'SPRST_ACTIVE_ALWAYS',
    'ISpeechPhraseReplacements', 'SVP_7', 'SPSNotOverriden',
    'SpeechTokenKeyFiles', 'DISPID_SPIEnginePrivateData',
    'SpNullPhoneConverter', 'SVESentenceBoundary',
    'ISpeechRecoResult2', 'SP_VISEME_2', 'SPLO_DYNAMIC',
    'SDA_No_Trailing_Space', 'eLEXTYPE_RESERVED10', 'SVP_0',
    'eWORDTYPE_ADDED', 'SpPhoneticAlphabetConverter',
    'SpeechCategoryAppLexicons', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SPEsCount', 'SRCS_Enabled',
    'DISPID_SASCurrentSeekPosition', 'SpSharedRecoContext',
    'SPWAVEFORMATTYPE', 'DISPIDSPTSI_ActiveOffset',
    'ISpeechObjectToken', 'SpeechFormatType', 'DISPID_SLPType',
    'DISPID_SWFEBitsPerSample', 'ISpeechPhraseElements',
    'SPPROPERTYINFO', 'SPPS_Modifier', 'DISPID_SRCEventInterests',
    'SpPhoneConverter', 'SVEStartInputStream', 'SRTAutopause',
    'SPAS_CLOSED', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SPIElements', 'DISPID_SPRuleFirstElement',
    'DISPID_SRRAudio', 'SAFT24kHz8BitStereo', 'ISpNotifySource',
    'SPFM_CREATE', 'SPPS_LMA', 'SPSMF_UPS', 'SPWT_LEXICAL',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SRCEAudioLevel', 'SREPrivate',
    'SPAS_RUN', 'DISPID_SAFType', 'SPSHT_Unknown',
    'SAFT16kHz8BitStereo', 'SpeechRecoEvents',
    'DISPID_SOTCGetDataKey', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SVSInputWordLength', 'DISPID_SVWaitUntilDone',
    'DISPID_SGRSTWeight', 'SPVISEMES', 'DISPID_SRRAudioFormat',
    'SPPS_RESERVED4', 'ISpeechPhoneConverter', 'DISPID_SGRsCount',
    'SASClosed', 'DISPID_SOTDataKey', 'SPPHRASEPROPERTY',
    'SpMMAudioOut', 'SPADAPTATIONRELEVANCE',
    'SpeechVoiceCategoryTTSRate', 'SDTAll', 'DISPID_SpeechBaseStream',
    'IStream', 'SPEVENTENUM', 'SGLexicalNoSpecialChars',
    'eWORDTYPE_DELETED', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'Speech_Max_Word_Length', 'DISPID_SpeechPhraseInfo',
    'DISPID_SpeechPhraseAlternates', 'SITooLoud', 'SPEI_HYPOTHESIS',
    'SpObjectTokenCategory', 'STCRemoteServer',
    'Speech_StreamPos_Asap', 'DISPID_SRCVoice', 'SPRULE',
    'DISPID_SVResume', 'SPCT_COMMAND', 'SFTInput', 'DISPID_SAVolume',
    'SPSHORTCUTTYPE', 'DISPID_SRCERecognition',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SOTDisplayUI',
    'SPGRAMMARSTATE', 'DISPID_SOTsItem', 'SAFT12kHz16BitMono',
    'SAFT16kHz8BitMono', 'SAFT8kHz8BitMono', 'SAFTNoAssignedFormat',
    'SAFT24kHz16BitMono', 'SECFNoSpecialChars', 'DISPID_SLGetWords',
    'SVSFParseSsml', 'ISpeechBaseStream', 'SVP_21', 'ISpEventSink',
    'SVP_13', 'SPAO_NONE', 'DISPID_SPCIdToPhone', 'SAFT32kHz8BitMono',
    'eLEXTYPE_PRIVATE10', 'ISpeechGrammarRules',
    'SAFTADPCM_44kHzMono', 'SVP_17', 'ISpeechLexiconPronunciations',
    ...
    'SVSFIsFilename', 'DISPID_SOTGetDescription', 'SITooFast',
    'DISPID_SRGCmdLoadFromResource', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SRCEInterference', 'SAFT12kHz16BitStereo',
    'SPLEXICONTYPE', 'SPBO_PAUSE', 'DISPID_SPIReplacements',
    'DISPID_SPPChildren', 'SAFTGSM610_8kHzMono',
    'ISpeechXMLRecoResult', 'DISPID_SPEDisplayText',
    'DISPID_SLPPartOfSpeech', 'SGDisplay',
    'DISPID_SPERequiredConfidence', 'SPBINARYGRAMMAR', 'SVP_12',
    'SVP_16', 'DISPID_SGRSRule', 'SPDKL_CurrentUser',
    'DISPID_SRCESoundStart', 'SPINTERFERENCE_TOOSLOW',
    'ISpeechAudioFormat', 'DISPID_SDKSetLongValue',
    'DISPID_SCSBaseStream', 'DISPID_SGRSTsCount',
    'SAFTADPCM_8kHzMono', 'DISPID_SRRDiscardResultInfo', 'SVP_3',
    'ISpLexicon', 'SPPHRASERULE', 'DISPID_SPPConfidence',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPAPhraseInfo',
    'SRARoot', 'ISpeechTextSelectionInformation',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SRAudioInput',
    'SP_VISEME_10', 'DISPID_SMSADeviceId',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SpeechRecoResult2',
    'DISPID_SRSetPropertyString', 'eLEXTYPE_PRIVATE5',
    'DISPID_SOTCEnumerateTokens', 'eLEXTYPE_RESERVED8', 'SGRSTTRule',
    'DISPID_SRRGetXMLResult', 'SPWORDTYPE', 'ISpProperties',
    'DISPID_SPARecoResult', 'SDA_One_Trailing_Space', 'SPXRO_SML',
    'SpeechPartOfSpeech', 'SVSFlagsAsync', 'SVEViseme', 'SPSUnknown',
    'SPSEMANTICERRORINFO', 'SpeechDiscardType',
    'ISpeechRecoResultTimes', 'DISPID_SLWWord',
    'DISPID_SLWPronunciations', 'SpeechDictationTopicSpelling',
    'SPCATEGORYTYPE', 'DISPID_SpeechMemoryStream',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPRuleParent', 'DISPID_SGRSTPropertyId',
    'DISPID_SRSClsidEngine', 'SpeechAudioProperties',
    'ISpeechRecoResult', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SVRate', 'SSSPTRelativeToStart', 'ISpRecoCategory',
    'SGSEnabled', 'DISPID_SBSRead', 'SWTDeleted',
    ...
    'DISPID_SRRRecoContext', 'UINT_PTR', 'SpSharedRecognizer',
    'DISPID_SpeechPhraseProperties', 'ISpStreamFormatConverter',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SREFalseRecognition',
    'SPWORDLIST', 'DISPID_SPRsItem', 'SAFTADPCM_22kHzMono',
    'SAFTNonStandardFormat', 'SPRECOSTATE', 'SpInprocRecognizer',
    'SpMemoryStream', 'ISpeechLexicon', 'SpeechGrammarTagDictation',
    'SPDKL_CurrentConfig', 'SREPhraseStart', 'DISPID_SFSClose',
    ...
    'DISPID_SPIAudioStreamPosition', 'SPRS_INACTIVE', 'IEnumString',
    ...
    'DISPID_SRRTLength', 'DISPID_SGRSTPropertyName',
    'SPEI_VOICE_CHANGE', 'SVSFVoiceMask', 'SVP_11',
    'DISPID_SRGetRecognizers', 'DISPID_SRCState',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRCResume', 'SRSActive',
    'SPEI_ADAPTATION', 'SPEI_MIN_SR', 'DISPID_SPPParent',
    'DISPID_SLWType', 'SECNormalConfidence',
    'DISPID_SGRSAddRuleTransition', 'SPWF_SRENGINE',
    'DISPID_SPIAudioSizeTime', 'DISPID_SpeechRecoContext',
    'SPPHRASEREPLACEMENT', 'SPEI_VISEME', 'DISPID_SABIEventBias',
    'SVEAllEvents', 'SpMMAudioEnum', 'SWTAdded',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRCEPhraseStart',
    'SAFT32kHz16BitStereo', 'SPINTERFERENCE_TOOQUIET',
    'SGPronounciation', 'DISPID_SRCEBookmark', 'SPEI_SOUND_START',
    'SP_VISEME_15', 'DISPID_SPPFirstElement', 'SpAudioFormat',
    'ISpeechAudio', 'SLTUser', 'SP_VISEME_5',
    'DISPID_SPAStartElementInResult', 'SDTDisplayText', 'SAFTText',
    'DISPID_SRProfile', 'DISPID_SPPValue', 'SPVPRI_ALERT',
    'DISPID_SDKDeleteValue', 'SAFT22kHz16BitStereo',
    'SpeechTokenShellFolder', 'SPEI_RECO_STATE_CHANGE',
    'SAFT44kHz8BitMono', 'SPAR_High', 'ISpRecoGrammar2',
    'SPEI_SR_PRIVATE', 'SAFT11kHz16BitStereo', 'SDTAlternates',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SSTTWildcard',
    'ISpeechLexiconWord', 'DISPID_SRRSpeakAudio',
    'DISPID_SVEStreamEnd', 'DISPID_SRCESoundEnd',
    'DISPID_SRDisplayUI', 'DISPID_SPEAudioStreamOffset',
    'SRTEmulated', 'SBOPause', 'SPRULESTATE', 'DISPID_SVEStreamStart',
    'DISPID_SDKSetBinaryValue', 'SASRun', 'SpeechInterference',
    'SAFT48kHz8BitMono', 'SpeechEngineProperties',
    'DISPID_SGRsCommitAndSave', 'DISPID_SLPPhoneIds', 'SPVPRIORITY',
    'SRERequestUI', 'SPEI_MAX_TTS', 'DISPID_SBSFormat',
    'SAFTADPCM_44kHzStereo', 'SRATopLevel', 'SVEPhoneme',
    'SpInProcRecoContext', 'SAFT22kHz8BitMono', 'SREHypothesis',
    'SAFT44kHz8BitStereo', 'SREStreamStart', 'STSF_LocalAppData',
    'Library', 'DISPID_SAFGuid', 'ISpeechLexiconPronunciation',
    'ISpeechPhraseInfo', 'SRAORetainAudio', 'SASStop', 'SRAImport',
    'DISPID_SpeechPhraseElement', 'DISPID_SGRSTType', 'SPWORD',
    'SDKLCurrentUser', 'DISPID_SGRId',
    'DISPID_SRGSetWordSequenceData', 'SDTLexicalForm',
    'ISpSerializeState', 'DISPID_SPRsCount', 'SpeechStreamFileMode',
    'DISPID_SLWsCount', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SPEPronunciation', 'SVSFParseSapi', 'SAFT22kHz8BitStereo',
    'SpUnCompressedLexicon', 'SECFIgnoreWidth',
    'DISPID_SRCEEnginePrivate', 'SPDKL_DefaultLocation', 'SVP_9',
    'SPPARTOFSPEECH', 'SRAInterpreter', 'DISPID_SMSALineId',
    'SpeechWordPronounceable', 'DISPID_SOTsCount', 'SLOStatic',
    'SWPUnknownWordPronounceable', 'SRTReSent', 'SGLexical',
    ...
    'SVSFNLPSpeakPunc', 'SPINTERFERENCE', 'DISPIDSPTSI',
    'DISPID_SpeechDataKey', 'SpeechCategoryRecognizers',
    'SGDSActiveWithAutoPause', 'eLEXTYPE_USER', 'ISpDataKey',
    'SPFILEMODE', 'typelib_path', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRGDictationUnload',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPSMF_SAPI_PROPERTIES',
    'SGRSTTWildcard', 'DISPID_SLPsItem', 'SRTExtendableParse',
    'SRTSMLTimeout', 'DISPID_SPRuleChildren',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SMSAMMHandle',
    'eLEXTYPE_LETTERTOSOUND', 'SPEVENTSOURCEINFO',
    'SpeechAudioFormatGUIDText', 'DISPID_SRGDictationLoad',
    'SSFMOpenReadWrite', 'DISPID_SVSLastResult',
    'DISPID_SVSPhonemeId', 'SAFT44kHz16BitStereo',
    'SAFT11kHz16BitMono', 'SRSInactive', 'DISPID_SRCRetainedAudio',
    'SVSFIsXML', 'tagSPPROPERTYINFO', 'DISPID_SRRSetTextFeedback',
    'SAFTADPCM_8kHzStereo', 'SPPS_NotOverriden',
    ...
    'SpeechDataKeyLocation', 'ISpeechCustomStream', 'ISpRecognizer',
    'SpNotifyTranslator', 'DISPID_SVEVoiceChange',
    'ISpeechRecognizerStatus', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRGRules', 'DISPID_SRCCreateGrammar', 'SGDSActive',
    'SASPause', 'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SRCBookmark',
    'SPAR_Low', 'DISPID_SpeechLexiconWords', 'DISPID_SAEventHandle',
    'DISPID_SVSInputWordPosition', 'SWPKnownWordPronounceable',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SRERecognition', 'SPSERIALIZEDPHRASE', 'SPSNoun',
    'ISpeechPhraseAlternate', 'DISPID_SVEPhoneme',
    'DISPID_SpeechGrammarRuleStateTransition', 'SSFMOpenForRead',
    'DISPID_SRGReset', 'DISPID_SpeechAudioStatus',
    'DISPID_SRCERequestUI', 'SAFT48kHz8BitStereo', 'SRCS_Disabled',
    'SPCONTEXTSTATE', 'SPLOADOPTIONS', 'SpTextSelectionInformation',
    'SPSInterjection', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVP_2',
    'ISpRecoResult', 'DISPID_SRGRecoContext', 'STSF_FlagCreate',
    'DISPID_SPRDisplayAttributes', 'SPEI_END_SR_STREAM',
    'ISpeechVoiceStatus', 'DISPID_SPRulesCount',
    'ISpeechObjectTokenCategory', 'DISPID_SOTCreateInstance',
    'eLEXTYPE_PRIVATE3', 'ISequentialStream', 'SpeechVoiceSpeakFlags',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SVEPrivate',
    'ISpeechPhraseProperty', 'SVP_18', 'SAFT16kHz16BitStereo',
    'SREInterference', 'ISpStream', 'DISPID_SGRAddResource',
    'DISPID_SPCLangId', 'DISPID_SVGetProfiles', 'DISPID_SVSpeak',
    'SPPS_Interjection', 'DISPID_SpeechObjectToken',
    'SGRSTTTextBuffer', 'DISPID_SpeechObjectTokens',
    'SPINTERFERENCE_LATENCY_WARNING', 'SP_VISEME_16',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SPPNumberOfElements',
    'DISPID_SPEActualConfidence', 'SpCompressedLexicon',
    'SPEI_MAX_SR', 'SVEAudioLevel', 'SVP_20', 'eLEXTYPE_APP',
    'SPWF_INPUT', 'SPEI_RESERVED3',
    'DISPID_SRCERecognizerStateChange',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SGRsFindRule',
    'DISPID_SVStatus', 'DISPID_SPRules_NewEnum', 'SAFT12kHz8BitMono',
    'DISPID_SpeechRecognizerStatus', 'SpeechAudioFormatGUIDWave',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRRSaveToMemory',
    'ISpResourceManager', 'SPBO_NONE', 'SAFT16kHz16BitMono',
    'SP_VISEME_7', 'DISPID_SAStatus', 'SPRST_ACTIVE',
    'SPEI_SENTENCE_BOUNDARY', 'SREPropertyNumChange',
    'DISPID_SDKGetlongValue', 'DISPID_SRGCommit', 'SpCustomStream',
    'eLEXTYPE_PRIVATE18', 'SP_VISEME_17', 'SAFTADPCM_11kHzStereo',
    'SPPS_Verb', 'SDTRule', 'DISPID_SLPsCount', 'SPINTERFERENCE_NONE',
    'DISPID_SpeechVoice', 'SAFTGSM610_22kHzMono',
    'eLEXTYPE_RESERVED7', 'DISPID_SPPs_NewEnum',
    'SPWORDPRONOUNCEABLE', 'SPSSuppressWord', 'eLEXTYPE_PRIVATE7',
    'SPRECOGNIZERSTATUS', 'SAFTCCITT_ALaw_11kHzMono',
    'SPEI_RECOGNITION', 'SpObjectToken', 'DISPID_SPACommit',
    'Speech_StreamPos_RealTime', 'SPPS_RESERVED2',
    'DISPID_SWFESamplesPerSec', 'SPBOOKMARKOPTIONS',
    'DISPID_SPIAudioSizeBytes', 'SPFM_OPEN_READWRITE',
    'ISpeechPhraseAlternates', 'ISpeechRecognizer',
    'SpeechPropertyLowConfidenceThreshold', 'SREStateChange',
    'SFTSREngine', 'eLEXTYPE_MORPHOLOGY',
    'SpeechVoiceSkipTypeSentence', 'eLEXTYPE_PRIVATE15',
    'DISPID_SLPSymbolic', 'DISPID_SLGetPronunciations',
    'SECFEmulateResult', 'DISPID_SPELexicalForm',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SRGId',
    'ISpRecognizer3', 'SPGS_EXCLUSIVE', 'SpVoice', 'SpeechRuleState',
    ...
    'SRSInactiveWithPurge', 'ISpeechResourceLoader',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SPPName',
    'SAFT24kHz16BitStereo', 'SpeechTokenIdUserLexicon',
    'DISPID_SABIBufferSize', 'WAVEFORMATEX', 'SPEI_MIN_TTS',
    'SPAUDIOSTATUS', 'eLEXTYPE_RESERVED6',
    'SDA_Consume_Leading_Spaces', 'ISpPhoneConverter',
    'SDTPronunciation', 'DISPID_SRCEFalseRecognition',
    'DISPID_SGRSTPropertyValue', 'ISpRecoGrammar', 'SpFileStream',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPRuleId',
    'DISPID_SPISaveToMemory', 'SPGS_DISABLED',
    'DISPID_SOTRemoveStorageFileName', 'SVP_14', 'SPXMLRESULTOPTIONS',
    'DISPID_SRSAudioStatus', 'SpeechRecognizerState', 'SPPHRASE',
    'SAFTCCITT_ALaw_8kHzMono', 'SPEI_FALSE_RECOGNITION',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPIRule',
    'DISPID_SpeechGrammarRuleState', 'SpeechMicTraining',
    'DISPID_SVSInputSentenceLength', 'SLODynamic', 'SLTApp',
    'SVEBookmark', 'SpeechVisemeType', 'SP_VISEME_3',
    'ISpeechRecoResultDispatch', 'eLEXTYPE_VENDORLEXICON',
    'SAFT11kHz8BitMono', 'LONG_PTR', 'SBONone',
    'DISPID_SpeechPhraseElements', 'SPEI_SR_BOOKMARK',
    'ISpeechAudioBufferInfo', 'ISpeechFileStream',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SVAudioOutputStream',
    'SAFTCCITT_ALaw_22kHzStereo', 'SREPropertyStringChange',
    'SP_VISEME_1', 'DISPID_SPPBRestorePhraseFromMemory', 'SVP_1',
    'DISPID_SGRsCommit', 'SAFTADPCM_11kHzMono', 'SGSDisabled',
    'SRAONone', 'DISPID_SVSkip', 'SPCT_DICTATION', 'SPWT_DISPLAY',
    'DISPID_SPANumberOfElementsInResult',
    'SpeechCategoryRecoProfiles', 'SpeechRecoProfileProperties',
    'DISPID_SRState', 'DISPID_SVESentenceBoundary',
    'DISPID_SOTGetAttribute', 'ISpPhraseAlt', 'SSFMCreate',
    'DISPID_SRCreateRecoContext', 'SPEI_WORD_BOUNDARY',
    'SPRST_NUM_STATES', 'SPEI_SOUND_END', 'SpeechTokenKeyUI',
    'DISPID_SDKSetStringValue', 'SREAdaptation',
    'SAFT48kHz16BitStereo', 'SPPS_Unknown', 'SPEI_START_SR_STREAM',
    'ISpeechLexiconWords', 'SVPAlert', 'DISPID_SASState',
    'DISPID_SpeechPhraseRule', 'SPAUDIOSTATE', 'DISPID_SPCPhoneToId',
    'DISPID_SOTId', 'DISPID_SRCCmdMaxAlternates', 'ISpeechVoice',
    'DISPID_SVEWord', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SRCEPropertyNumberChange', 'eLEXTYPE_PRIVATE12',
    'DISPID_SOTCategory', 'SAFT22kHz16BitMono', 'SP_VISEME_4',
    'SVP_5', 'eLEXTYPE_PRIVATE16', 'SSTTTextBuffer',
    'SPAO_RETAIN_AUDIO', 'SPEI_RESERVED2', 'SITooSlow',
    'DISPID_SPEAudioSizeBytes', 'ISpShortcut', 'DISPID_SPIGetText',
    'SRSEIsSpeaking', 'ISpPhoneticAlphabetConverter',
    'DISPID_SRCEEndStream', 'DISPID_SRRTimes',
    'DISPID_SLAddPronunciation', 'ISpGrammarBuilder', 'SINoise',
    'DISPID_SRCEPropertyStringChange', 'DISPIDSPRG',
    'ISpeechMemoryStream', 'SPEI_RESERVED5', 'ISpAudio',
    ...
    'DISPID_SGRSTransitions', 'ISpeechPhraseRule',
    'SAFTGSM610_11kHzMono', '_SPAUDIOSTATE', 'DISPID_SVGetVoices',
    'DISPID_SGRsAdd', 'SREAudioLevel', 'ISpeechObjectTokens',
    'DISPID_SGRAttributes', 'ISpXMLRecoResult', 'SRSEDone'
]

_check_version('1.3.1', 1748158395.890573)
